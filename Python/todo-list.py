...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Simple Todo-List app with Python and SQLite"
    )
    parser.add_argument("-a", "--add", metavar="", help="Add new task")
    parser.add_argument(
        "-s", "--status", type=int, choices=[1, 2, 3], help="1 IDEA 2 DOING 3 DONE"
    )
    ...
    parser.add_argument(
        "-c", "--change", metavar="id", help="Change status IDEA/DOING/DONE"
    )
    return parser
